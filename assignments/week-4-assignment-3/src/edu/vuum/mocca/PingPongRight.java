...
public class PingPongRight {
    ...
    public static void process(String startString, 
        ...
        PlayPingPongThread ping = new PlayPingPongThread(startString, pingSema, pongSema, maxIterations);
        PlayPingPongThread pong = new PlayPingPongThread(startString, pingSema, pongSema, maxIterations);
